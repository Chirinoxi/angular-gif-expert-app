...
export enum Title {
  NarutoGIFByCrunchyroll = 'Naruto GIF by Crunchyroll',
  NarutoShippudenEatingGIF = 'naruto shippuden eating GIF',
...
const typeMap: any = {
  ...
  Rating: ['g', 'pg', 'pg-13'],
  Title: [
    'Naruto GIF by Crunchyroll',
    'naruto shippuden eating GIF',
